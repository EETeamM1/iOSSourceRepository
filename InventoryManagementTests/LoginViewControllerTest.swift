...
NSLog("count is %s",loginViewController.childViewControllers.count)
            XCTAssertTrue(self.loginViewController.presentedViewController is UIAlertController, "Alert not appeared")
            XCTAssertEqual(loginViewController.presentedViewController?.title, "IMEI no.")
    }
